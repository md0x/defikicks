...
const maxRetries = 3
const retrySleepTime = 10 * 1000

const sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms))

export async function paginatedEventQuery(contract, filter, searchConfig, retryCount = 0) {
...
export function getPaginatedBlockRanges({ fromBlock, toBlock, maxBlockLookBack }) {
