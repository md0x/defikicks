...
export interface DefiKicksDataGovernanceTokenInterface extends utils.Interface {
  functions: {
...
export interface DefiKicksDataGovernanceToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DefiKicksDataGovernanceTokenInterface;
