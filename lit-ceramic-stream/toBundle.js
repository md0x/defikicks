// const code = `
//   async function generateRandomNumber(nodeUrl1) {
...
//   function run() {
//     return generateRandomNumber(nodeUrl1);
//   }
...
// const code = `async function i(e){let r=await new ethers.providers.JsonRpcProvider(e).getBlockNumber(),n="DefiKicks",t=r.toString()+n,o=ethers.utils.solidityKeccak256(["string"],[t]),s=1e8-5e7;return parseInt(o,16)%s+5e7}function u(){return i(nodeUrl1)}u();
// `
...
const go = async () => {
    ...
    // TODO ipfs hash should be read
    const code = await downloadIpfsFile("QmTtHUUeHVWqpwC83k1ZBAjm93GQzD5HHE9iwd9hFxaiFn")
